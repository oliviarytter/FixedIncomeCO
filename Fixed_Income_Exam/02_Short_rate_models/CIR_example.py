...
fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2025/Examples/CIR/cir_zcb_plot.pdf")
...
labels = [item.get_label() for item in plots]
ax.legend(plots,labels,loc="lower right",fontsize = 5)
fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2025/Examples/CIR/cir_swap_plot.pdf")
...
fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2025/Examples/CIR/cir_simul_plot.pdf")
...
if interpolation_options["method"] == "hermite":
    ...
    ax.text(0.32,0.0023,f" method: {interpolation_options['method']} \n transition: {interpolation_options['transition']}", fontsize = 6,linespacing = 1.7, bbox = bbox)
fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2025/Examples/CIR/zcb_market_fit_plot.pdf")
plt.show()
